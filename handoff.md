...
**Divergence doc filed:** `docs/divergences/DIV-0007-compile-to-closure-needs-caller-owned-datum-arena.md` (status `accepted-permanent`) — see above. Next free divergence number after this step: **DIV-0008** (re-check `docs/divergences/` before filing, since L18 may have run concurrently in a sibling worktree).
