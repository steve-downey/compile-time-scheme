...
replaces ~std::indirect~.
#+end_abstract

#+MACRO: TEASER_END
{{TEASER_END}}
#+html: <nav style="margin-bottom: 2em; border-bottom: 1px solid #ccc; padding-bottom: 1em">
[[file:index.org][↑ Series Index]] | [[file:phase-0-intro.org][Phase 0 - Introduction ←]]
#+html: </nav>
...
[[file:index.org][↑ Series Index]] | [[file:phase-2-front-end.org][Next: Phase 2 - Front End →]]
#+html: </nav>
