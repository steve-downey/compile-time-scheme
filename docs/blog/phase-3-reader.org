...
[[file:index.org][↑ Series Index]] | [[file:phase-2-front-end.org][Phase 2 - Front End ←]]
#+html: </nav>
...
represents data also represents code — the data/code duality of S-expressions
that goes back to McCarthy's original Lisp [cite:@mccarthy1960recursive]. The reader produces the same structure
...
The recursive cases — list and quote — need to refer to child datums. The
open-recursive fixpoint pattern does the work here.
...
~read_datum_node~ does the recursive descent: it dispatches on the first
...
[[file:index.org][↑ Series Index]] | [[file:phase-4-elaboration.org][Next: Phase 4 - Elaboration →]]
#+html: </nav>
