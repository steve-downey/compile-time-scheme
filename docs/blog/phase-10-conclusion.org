...
- **Lambda the Ultimate GOTO** [cite:@steele1976lambda] - Guy L. Steele Jr.'s seminal paper establishing that compiling functional closures directly maps to memory jumps natively.
- **Applicative Programming with Effects** [cite:@mcbride2008applicative] - A primer on the Applicative/Traversable structures utilized to format the DOT graphs.
