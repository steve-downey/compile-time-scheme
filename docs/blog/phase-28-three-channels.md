...
<div class="abstract" id="org8029c36">
<p>
...
Phase 27 ended on a question: whether an evaluator over the same core tree could stay in the shape the elaborator is in: three index loops and no recursive descent, because a `tagged_tree` built children-before-parent has its nodes in topological order already. I wrote that I didn't see why it couldn't, and that this wasn't the same as knowing. It couldn't, and it isn't close.
