...
This recursively unpacks the deeply typed sequence and maps it onto a homogenously typed ~SchemeTree~ topology, annotating both the Sender algorithm and its originating Scheme context.
