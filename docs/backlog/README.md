...
| [BL-0013](BL-0013-two-step-series-share-one-numbering.md) | Give `checklist.md`'s two step series slugs; keep ordinals as reading order | open — scheduled after the Phase B merge, which ticks the lines it would edit |
