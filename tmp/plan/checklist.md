...
- [x] B5 — `tmp/plan/step-B5.md` — text: strings and character literals
- [x] B6 — `tmp/plan/step-B6.md` — forms: the quote family and token data
- [x] B7 — `tmp/plan/step-B7.md` — sharpsign dispatch and `read_node`
- [x] B8 — `tmp/plan/step-B8.md` — integration: the D30 measurement, DIV-0028 dissolved, architecture section, project checklist
