...
// src/smd/smdscheme/reader/reader_atom.hpp                     -*-C++-*-// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception#ifndef SRC_SMD_SMDSCHEME_READER_READER_ATOM_HPP#define SRC_SMD_SMDSCHEME_READER_READER_ATOM_HPP
