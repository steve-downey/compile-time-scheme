// src/smd/smdscheme/foundation/source_span.test.cpp             -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception

#include <smd/smdscheme/foundation/source_span.hpp>
#include <smd/smdscheme/foundation/source_span.hpp> // test 2nd include OK

#include <catch2/catch_test_macros.hpp>

using smd::smdscheme::foundation::source_pos;
using smd::smdscheme::foundation::source_span;
