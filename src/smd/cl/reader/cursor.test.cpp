// src/smd/cl/reader/cursor.test.cpp                              -*-C++-*-
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception

#include <smd/cl/reader/cursor.hpp>
#include <smd/cl/reader/cursor.hpp> // test 2nd include OK

#include <catch2/catch_test_macros.hpp>

using smd::cl::reader::advance_while;
using smd::cl::reader::cursor;
using smd::cl::reader::parse_state;
