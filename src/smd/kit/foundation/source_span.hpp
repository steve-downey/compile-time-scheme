...
// src/smd/forth/foundation/source_span.hpp (compile-time-forth). Those two
// copies were identical apart from include guard, namespace, and comment —
// the zero-drift signal decision R8 acts on.
