// src/smd/kit/foundation/parse_error.test.cpp                       -*-C++-*-
...
// src/smd/smdscheme/foundation/parse_error.test.cpp (compile-time-scheme)
// and src/smd/forth/foundation/parse_error.test.cpp (compile-time-forth).

#include <smd/kit/foundation/parse_error.hpp>
#include <smd/kit/foundation/parse_error.hpp> // test 2nd include OK
